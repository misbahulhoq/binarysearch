...
const FeatureCard = ({ props }: { props: Props }) => {
  ...
  return (
    <div className="flex items-center justify-center p-8 self-stretch">
      <div className="group max-w-72 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-0.5 rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
