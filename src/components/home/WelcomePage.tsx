            ...
            <section className="container min-h-screen mx-auto px-6 py-24 lg:py-0  flex flex-col md:flex-row items-center">
              ...
              >
                ...
                <p className="text-xl mb-8">
                  আজ থেকেই আপনার কোডিং জার্নি শুরু করুন <br /> আমাদের
                  ইন্টারেক্টিভ জাভাস্ক্রিপ্ট কোর্সের সাথে
                </p>
                  ...
                  <div className="bg-slate-800 rounded-lg p-6 shadow-xl w-full max-w-md border border-slate-700">
                    ...
                    <pre className="text-sm font-mono">
                      ...
                      <code className="text-blue-400">
                        function{" "}
                        <span className="text-yellow-400">greetCoder</span>
                        () {"{"}
                      </code>
                      <br />
                      <code>
              ...
              {/* <div className="container mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  <div className="bg-slate-700 p-6 rounded-lg hover:shadow-lg hover:shadow-indigo-500/30 transition">
                    ...
                    <p className="text-slate-300">
                      আমাদের এই কোর্সটি সম্পূর্ণ বাংলা ভাষায়, তাই আমরা আশা করছি
            ...
            <section className="container mx-auto px-6 py-20">
              <div className="bg-gradient-to-r from-indigo-800 to-purple-800 rounded-xl p-8 text-center">
                ...
                <p className="text-xl mb-8 max-w-2xl mx-auto">
                  We&apos;re currently focused on JavaScript, but we&apos;re
                  working hard to bring you courses on Python, React, Node.js,
                  and more!
                </p>
