...
const ComingSoonSection = () => {
  return (
    <section className="px-6 py-20 bg-gradient-to-r from-indigo-800 to-purple-800 rounded-xl p-8 text-center">
      <div className="">
        <h2 className="text-3xl font-bold mb-4">আগামীতে আরও কোর্স আসবে</h2>
